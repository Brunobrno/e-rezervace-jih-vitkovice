...
import { createSquare } from "../../../api/model/square";
...
export default function SquareDesigner() {
  ...
  const handleImageChange = (e) => {
    ...
    if (file) {
      ...
      img.onload = () => {
        ...
        setFormData((old) => ({
          ...old,
          width: Math.sqrt(old.area * aspect),
          height: Math.sqrt(old.area / aspect),
        }));
      };
      img.src = url;
      setStep(2);
  ...
  return (
    <Container className="py-4">
      ...
      <Button variant="secondary" href="/squares">Zpět na seznam náměstí</Button>
